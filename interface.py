...
class Application:
    def __init__(self, master=None):
        ...
        self.lblid_usuario = Label(self.container2,
        text="id_usuario:", font=self.fonte, width=10)
        self.lblid_usuario.pack(side=LEFT)

        self.txtid_usuario = Entry(self.container2)
        self.txtid_usuario["width"] = 10
        self.txtid_usuario["font"] = self.fonte
        self.txtid_usuario.pack(side=LEFT)
    ...
    def inserirUsuario(self):
        ...
        self.txtid_usuario.delete(0, END)
    ...
    def alterarUsuario(self):
        ...
        user.id_usuario = self.txtid_usuario.get()
        user.nome = self.txtnome.get()
        user.telefone = self.txttelefone.get()
        user.email = self.txtemail.get()
        user.usuario = self.txtusuario.get()
    ...
    def buscarUsuario(self):
        ...
        id_usuario = self.txtid_usuario.get()

        self.lblmsg["text"] = user.selectUser(id_usuario)

        self.txtid_usuario.delete(0, END)
        self.txtid_usuario.insert(INSERT, user.id_usuario)
